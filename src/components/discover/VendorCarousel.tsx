...
import { hasSomethingToSell } from '@/components/VendorShowcaseCard';
...
export function VendorCarousel({ title, vendors, allProducts }: VendorCarouselProps) {
  ...
  // See VendorShowcaseCarousel — empty shops never reach a card.
  ...
  return (
    <div className="flex flex-col" style={{ gap: '16px' }}>
      ...
      <div className="flex items-center" style={{ gap: '8px' }}>
        <h3 style={{ fontSize: '12px', fontWeight: 900, color: 'var(--text-primary)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
          {title}
        </h3>
      ...
      <div className="relative group/row">
        ...
        {sellingVendors.length > 3 && (
          <button
            ...
            style={{ right: '-8px', top: '50%', transform: 'translateY(-50%)', width: '40px', height: '40px', borderRadius: '50%', background: 'var(--bg-base)', border: '1px solid var(--border-glass)', cursor: 'pointer', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}
          >
