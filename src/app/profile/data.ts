...
export const suggestedAddresses = [
  ...
  // ── United States ──
  { main: 'Manhattan', sub: 'New York, NY, United States' },
  { main: 'Brooklyn', sub: 'New York, NY, United States' },
  { main: 'Downtown Houston', sub: 'Houston, TX, United States' },
  { main: 'Midtown Atlanta', sub: 'Atlanta, GA, United States' },
  { main: 'South Side Chicago', sub: 'Chicago, IL, United States' },
  { main: 'Beverly Hills', sub: 'Los Angeles, CA, United States' },
  { main: 'Capitol Hill', sub: 'Washington, DC, United States' },
  { main: 'Buckhead', sub: 'Atlanta, GA, United States' },
  { main: 'Brickell', sub: 'Miami, FL, United States' },
  { main: 'The Woodlands', sub: 'Houston, TX, United States' },
  // ── United Kingdom ──
  { main: 'Mayfair', sub: 'London, England, United Kingdom' },
  { main: 'Shoreditch', sub: 'London, England, United Kingdom' },
  { main: 'Kensington', sub: 'London, England, United Kingdom' },
  { main: 'Brixton', sub: 'London, England, United Kingdom' },
  { main: 'Peckham', sub: 'London, England, United Kingdom' },
  { main: 'Northern Quarter', sub: 'Manchester, England, United Kingdom' },
  { main: 'Digbeth', sub: 'Birmingham, England, United Kingdom' },
  { main: 'Toxteth', sub: 'Liverpool, England, United Kingdom' },
  { main: 'Merchant City', sub: 'Glasgow, Scotland, United Kingdom' },
  { main: 'Chapeltown', sub: 'Leeds, England, United Kingdom' },
];
